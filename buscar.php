<?php
	...
	<?php
		...
		//caso o filtro não obtenha nenhum jogo, mostrar outros jogos para o cliente
		?>
		...
		<div class="row nopadding">		
			<div class="alert alert-warning alert-dismissible fade show" role="alert" style="border-radius: 0; width:100%; ">
				<strong>Hmmmmm!</strong> Nada encontrado para o termo escolhido, mas selecionamos outros jogos que possa gostar
